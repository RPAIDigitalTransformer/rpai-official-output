...
import { d as useRuntimeConfig$1, h as createError$1, $ as $fetch$1, k as hasProtocol, p as parseURL, l as parseQuery, m as createHooks, w as withTrailingSlash, n as withoutTrailingSlash, o as withQuery, j as joinURL, q as defu, r as sanitizeStatusCode } from '../nitro/node-server.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/Contact-bcd7087f.mjs').then((m) => m.default || m)
  },
  {
    name: "slug",
    path: "/:slug(.*)*",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-f99ba64e.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-4beb496e.mjs').then((m) => m.default || m)
  }
];

...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.2744340f.mjs').then(interopDefault),
  "pages/Article.vue": () => import('./_nuxt/Article-styles.154d5cbf.mjs').then(interopDefault),
  "pages/Case.vue": () => import('./_nuxt/Case-styles.ea085c01.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.04c2f8e8.mjs').then(interopDefault),

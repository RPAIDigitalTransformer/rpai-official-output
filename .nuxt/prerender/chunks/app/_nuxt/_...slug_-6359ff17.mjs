...
import { withCtx, createVNode, toDisplayString, useSSRContext } from 'file://E:/desktop-temp/sources/rpai/rpai-official/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate } from 'file://E:/desktop-temp/sources/rpai/rpai-official/node_modules/vue/server-renderer/index.mjs';
...
import 'file://E:/desktop-temp/sources/rpai/rpai-official/node_modules/property-information/index.js';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_ContentDoc, null, {
    default: withCtx(({ doc }, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h1${_scopeId}>${ssrInterpolate(doc.title)}</h1>`);
...
//# sourceMappingURL=_...slug_-6359ff17.mjs.map

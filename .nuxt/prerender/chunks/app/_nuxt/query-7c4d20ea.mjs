import { ref, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file://E:/desktop-temp/sources/rpai/rpai-official/node_modules/vue/index.mjs';
import { e as useNuxtApp, c as createError, b as useRuntimeConfig } from '../server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file://E:/desktop-temp/sources/rpai/rpai-official/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-83c34ac4.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-7c4d20ea.mjs.map
